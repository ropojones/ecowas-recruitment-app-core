...
{
    public abstract class EcoRecruitWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EcoRecruitWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EcoRecruitWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EcoRecruitDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EcoRecruitDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EcoRecruitDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EcoRecruitDbContext, Task<T>> func)
        {
            T result;
